            ...
            <div class="relative min-h-screen flex flex-col items-center  selection:bg-[#FF2D20] selection:text-white">
                <div class="relative w-full max-w-2xl  lg:max-w-7xl">
                    <header class=" px-6 grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
                        <a href="{{url()->previous()}}" class="flex  lg:col-start-2">
                            <i class="fa-solid fa-arrow-left  fa-2xl w-auto text-white lg:h-16 lg:text-[#FF2D20]"></i>
                        </a>

                    </header>

                    <main class="p-4">
                        <ul class="rounded-sm text-white bg-amber-500 bg-opacity-50  z-10 p-3 shadow-lg">
                            @foreach ($cart_products as $product)
                                <li class="grid grid-cols-3 gap-4 mb-2 p-2 border-b border-gray-200">
                            ...
                            @endforeach
                            <li class="grid grid-cols-3 gap-4 mb-2 p-2 bg-gray-400">
